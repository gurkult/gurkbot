...
class GitHub(Cog):
    ...
    async def contributors(self, ctx):
        ...
        em.add_field(name='You Can Contribute Too!',
        ...
        if results_count == 0:
            ...
            if len(response['items']) > 3:
                ...
                absolute_result_embed.add_field(
                    name='Description', value=absolute_result['description'], inline=False)
                absolute_result_embed.add_field(name='Most Used Language',
                                                value=absolute_result['language'], inline=False)
                absolute_result_embed.add_field(
